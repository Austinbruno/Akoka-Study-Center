...
const Footer = () => {
    ...
    return (
        <div>
            <div className="flex items-start p-[50px_80px]">
                <div className="mr-[54px]">
                    <Image src={logo} alt="logo" width={120} height={120} />
                </div>

                <div className="grid grid-flow-col gap-[74px]">
                    ...
                    <div className="flex flex-col ">
                        {footerNumbers.map((num, index) => {
                            return (
                                <div
                                    key={index}
                                    className="flex items-center m-[10px_0px]"
                                >
                    ...
                    <div className="mt-[10px]">
                        ...
                        <div>
                            <input
                                ...
                                className="border-[solid] border-[#667085] border-[1px]font-[400] text-[16px] leading-[24px] text-[#667085] rounded-[8px] mr-[16px]"
                            />
