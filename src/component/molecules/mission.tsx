...
const Mission = () => {
  ...
  return (
    <>
      ...
      <div className="xl:flex md:flex md:flex-col xl:flex-row  xl:gap-[17px] sm:px-[10px] justify-center mb-[90px] ">
        <Image
          src={missionImg}
          alt="mission"
          width={590}
          height={400}
          objectFit="cover"
          className="rounded-md object-[0_-20px]"
        />
        <div className="xl:w-[593px] md:w-[593px] text-justify xl:mt-[80px] sm:mt-[40px]">
          <p className="text-[#667085] font-[400] leading-[24px] xl:text-[16px] sm:text-[14px] font-poppins">
          ...
          <h1 className="leading-[24px] md:text-start sm:text-center font-[500] font-inter text-[20px] mb-[8px] text-[#344054] pt-[32px]">
            Our Mission
          </h1>
