    ...
    <div className="mx-auto ">
      ...
      <div className="items-center justify-center w-[1279px] mx-auto">
        <p className="ml-[90px] mb-[36px] font-[400] text-[18px] leading-[27px] text-[#667085]">
          Akoka Study Centre is one of the hundreds of centers around the world
          inspired by the teachings of St.josemaria Escriva, the <br />
          Founder of opus Dei - an institution of the Catholic Church that
          Promotes the universal call to holiness by teaching that <br />
          professional work and study can be sanctified by doing it well, with
          love and for the glory.{" "}
        </p>
